...
import request from 'sonos-discovery/lib/helpers/request.js';
...
async function generateBearerToken(apiKey) {
...
async function microsoft(phrase, voiceName) {
  if (!mySettings.microsoft || !mySettings.microsoft.key) {
    return Promise.resolve();
  }

  const settings = Object.assign({}, DEFAULT_SETTINGS, mySettings.microsoft);
